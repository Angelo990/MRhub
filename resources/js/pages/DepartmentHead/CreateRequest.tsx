            ...
            <div className="mx-auto w-full max-w-3xl p-4 sm:p-6">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6">
                    ...
                    <div className="flex flex-col justify-end gap-2 sm:flex-row">
                        ...
                        <Button type="submit" variant="default" disabled={loading || !!(budgetInfo && totalValue > budgetInfo.available_amount)} className="w-full sm:w-auto">{loading ? 'Submitting…' : 'Submit Request'}</Button>
                    </div>
                </form>
